        ...
        <div className="flex flex-col lg:flex-row gap-2">
          {options.map((option) => (
            <button
              ...
              className="flex-grow rounded-md bg-indigo-600 px-4 py-2 text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              {option.title}
            </button>
          ))}
